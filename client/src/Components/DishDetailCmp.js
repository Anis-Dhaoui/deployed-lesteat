                                        ...
                                        <ListGroup key={cmnt._id} className="mb-2">
                                            <ListGroupItem style={{backgroundColor: "gray"}}>
                                                <div className="rating">
                                                    {/* eslint-disable */}
                                                    <Control.radio defaultValue={cmnt.rating.toString()} model=".updatedRate" className="form-control" name="updateRating" value="5" id="update5" /><label htmlFor="update5">☆</label>
                                        ...
                                        <ListGroupItem className="" style={{backgroundColor: "gray"}}>
                                            <ListGroupItemHeading className="" > 
                                                ...
                                                <LocalForm className="rating rating-view-only" style={{position:"absolute", right:"0", bottom:"0", margin:"0 10px 5px 0"}}>
                                                    {/* eslint-disable */}
                                                    <Control.radio defaultValue={cmnt.rating.toString()} model=".ratedStars" disabled className="form-control" name="ratedStars" value="5" id="star5" /><label htmlFor="star5">☆</label>
